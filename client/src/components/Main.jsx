    ...
    return (
      <div className="mainarea">
        <div className="breadcrumbs">
          ...
          <span className="breadcrumb text link orange">
            Weapons, Bowsprits, and Rudders
          </span>
          /<span className="breadcrumb text link orange">Steers</span>/
          <span className="breadcrumb text gray">{this.state.product}</span>
        </div>
        <h1 className="text title">{this.state.product}</h1>
        <div>
          ...
          <div id="checkout"></div>
          <div>
            <span className="padleft part text gray bold">
              Part Number: <span className="light">112-358</span>
            </span>
          </div>
          <div>
            <span className="padleft part text gray bold">
              Alternate Part Number: <span className="light">P1R4T3</span>
            </span>
          </div>
          <div>
            <span className="padleft part text gray bold">
              Warranty:{" "}
              <span className="light orange link">Limited Lifetime</span>
            </span>
          </div>
        </div>
        <Star />
